# workshop4.py the other one is done!
...
# Task 4: Add BankUser class instance methods
    def show_balance(self):
        print(f"{self.name} has an account balance of: {self.balance:.0f}")
...
# bank_user1 = BankUser("Charlie", 5678, "securepass")
# bank_user1.show_balance()  # Initial balance
# bank_user1.deposit(1000)
# bank_user1.show_balance()  # After deposit
# bank_user1.withdraw(500)
# bank_user1.show_balance()  # After withdrawal

""" Driver Code for Task 5 """
bank_user1 = BankUser("Charlie", 5678, "securepass")
bank_user2 = BankUser("Dana", 1234, "mypassword")
...
if bank_user2.transfer_money(500, bank_user1, 1234):
     ...
     bank_user1.show_balance()
     bank_user2.show_balance()
     if bank_user2.request_money(200, bank_user1, 5678, "mypassword"):
